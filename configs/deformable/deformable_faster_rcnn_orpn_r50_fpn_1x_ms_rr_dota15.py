...
model = dict(
    ...
    deform=dict(
        type='Deform',
        density_use_layer=0,
        density_channels=[256, 512, 1024, 2048],
        loss_mask=dict(
            type='MSELoss',
            loss_weight=0.1),
        loss_re=dict(type='SmoothL1Loss', beta=1.0, loss_weight=0.2),
        grid_size=256,
        padding_size=32,
        ...
        depth=50,
        pretrained=None,
        pretrained_deform='torchvision://resnet50'),
    neck=dict(
        type='FPN',
